...
// Epoch of 15min before current date time
export const getBeforeminutesAgoEpoch = (min) => {
    const currentDate = new Date();
    const fifteenMinutesAgoEpoch = currentDate.getTime() - parseInt(min) * 60 * 1000;
    return Math.floor(fifteenMinutesAgoEpoch / 1000);
};
